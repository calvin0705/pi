...
def ntp_service():
    ...
    cmd1 = "sudo ntpdate -u 10.8.2.103"  # CED / DQH
    cmd2 = "sudo ntpdate -u 10.0.105.158"  # TFA20
    cmd3 = "sudo ntpdate -u 10.3.2.100"  # HBC
    ntp_return1 = str(os.system(cmd1))
    print("[ntp_return1] ntpdate cmd return : " + ntp_return1)
    time.sleep(0.5)
    
    if (ntp_return1 != "0"):
        ntp_return2 = str(os.system(cmd2))
        print("[ntp_return2] ntpdate cmd return : " + ntp_return2)
        time.sleep(0.5)
        
    if (ntp_return2 != "0"):
        ntp_return3 = str(os.system(cmd3))
        print("[ntp_return3] ntpdate cmd return : " + ntp_return3)
        time.sleep(0.5)
